...
var content = require('../src/contentRetriever');
...
describe("the content retriever", function() {
  ...
  it("has any other invalid character replaced by space", function() {
  ...
  var expectContent = function(sourceHtml, expectedText) {
    ...
    var contentRetriever = content.contentRetriever(spy,
